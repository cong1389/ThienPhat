...
namespace App.Infra.Data.Mapping
{
	public class LandingPageConfiguration : EntityTypeConfiguration<LandingPage>
	{
		public LandingPageConfiguration()
		{
			...
			base.HasRequired<ContactInfomation>((LandingPage x) => x.ContactInfomation).WithMany((ContactInfomation x) => x.LandingPages).HasForeignKey<int>((LandingPage x) => x.ShopId);
		}
	}
}