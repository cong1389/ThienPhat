...
namespace App.Infra.Data.Mapping
{
	public class LandingPageConfiguration : EntityTypeConfiguration<LandingPage>
	{
		public LandingPageConfiguration()
		{
			...
			base.HasRequired<ContactInformation>((LandingPage x) => x.ContactInformation).WithMany((ContactInformation x) => x.LandingPages).HasForeignKey<int>((LandingPage x) => x.ShopId);
		}
	}
}