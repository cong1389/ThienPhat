...
function loadVideo(){
        // alert('1');
        $.ajax({
            url: ROOT_MAIN + '/popup.html/?type=load_video',
            type: 'POST',
            method: 'POST'
        }).done(function(value) {
            // console.log(value);
...
$(document).ready(function(){
    ...
    //     console.log(ROOT_MAIN + '/popup.html/?type=load_video');
    ...
    //         $.ajax({
	   ...
	   //          method: 'POST'
	   //      }).done(function(value) {
	   //          $(".div_video_ajax").html(value);
	   //      });
    //     };

    // })(jQuery);

    $("#vnt-slide-product1").slick({
        arrows: false,
        dots:false,
        speed: 3000,
        fade: true,
