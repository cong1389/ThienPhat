$(document).ready(function($){
    ...
    $("#vnt-home-slide").slick({
        arrows: false,
        dots:true
    });
    $("#vnt-page-slide").slick({
        arrows: false,
        dots:false
    });
});
...
jQuery(document).ready(function ($) {
    var options1 = {
        ...
        $SlideWidth: 178,                                   //[Optional] Width of every slide in pixels, default value is width of 'slides' container
    ...
    var jssor_1_slider = new $JssorSlider$("vnt-home-partner-slider", options1);
});
